...
3. search VLO for the exact title `Ainglish training pack v4`;
...
|---|---|
| Title | Ainglish training pack v4 |
| Alternative title | Ainglish release 4 public-domain training data |
| Description | Train-only JSONL, Parquet, Dolma and Croissant projections of 32 ratified Ainglish agent-communication constructs and 66 reviewed Ainglish to careful-English usage pairs, bound to a frozen source release. |
...
| Download / manifest | https://ainglish.org/training/ainglish-training-v4/MANIFEST.json |
| Croissant metadata | https://ainglish.org/training/ainglish-training-v4/metadata/croissant.json |
| Related source release | https://ainglish.org/releases/ainglish-core-v4/MANIFEST.json |
| Related source DOI | https://doi.org/10.5281/zenodo.22849320 (release 4; concept DOI https://doi.org/10.5281/zenodo.22095467) |
