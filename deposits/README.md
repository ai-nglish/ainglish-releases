...
Ltd needs to submit Ainglish training pack v4 to external catalogues.

- `ainglish-training-v4.tar.gz` is a deterministic single-file copy of the complete pack.
...
python3 tools/build_training_archive.py \
  ...
  deposits/ainglish-training-v4.tar.gz --check
```
