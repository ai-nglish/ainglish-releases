# Datasheet: Ainglish training pack v3
...
The pack contains 27 current ratified constructs, 21
canonical usage-pair rows, and 42 reviewed non-normative usage-pair
rows. Those source rows deterministically produce 153 instruction rows and
27 self-contained pretraining documents. There is one train split and
no validation or test split.

## Collection and provenance

Every language row comes from the frozen `ainglish-core-v3` bundle. The source bundle
